...
create database UTN_TECNICATURA_
use UTN_TECNICATURA_
...
insert into Personas values ('Miguel ','González',20, '15/07/1999',2, 3, 5)
insert into Personas values ( 'Juan''Rodríguez ',21, '12/09/2003',2, 3, 7)
insert into Personas values ('Carlos','Gómez',22, '04/06/2001',2, 3, 3)
insert into Personas values ('Alberto','Fernández',23, '18/11/2003',1, 3, 2)
insert into Personas values ( 'José ','López',24, '06/06/2002',1, 3, 11)
insert into Personas values ('Luis','Martínez',25, '17/07/2002',2, 3, 8)
insert into Personas values ('Sofía','Sánchez ',26, '06/09/1999',2, 3, 9)
insert into Personas values ('María','Romero ',27, '18/10/2002',2, 3, 7)
insert into Personas values ('Lucía','Sánchez ',28, '06/12/2002',2, 3, 1)
insert into Personas values ('Martina','González  ',29, '19/08/2003',1, 3, 2)
insert into Personas values ('Catalina','Recio ',30, '06/09/2002',1, 3, 7)
insert into Personas values ('Elena','Giambo ',31, '18/02/1999',2, 1, 10)
...
insert into personas values('pepe' , 'Suarez',32 , '1995/06/03' , 1 , 3, 4)
 ...
 select * from Personas p join Contactos c on c.id_contacto=p.id_contacto
...
select * from Profesores p join Personas pe on pe.id_persona=p.id_persona
--NUEVO
...
join materias_alumnos ma on ma.id_materia=m.id_materia
--Tabla Tecnicaturas
...
select * from mat
select * from detalle_Examenes de join examenes e on e.id_examen=de.id_examen
join materias m on m.id_materia=e.id_materia
...
having count(e.id_examen) > (select avg(e2.id_examen)
				...
				exec SP_CONSULTA_1 2022, Beatriz,2,9
